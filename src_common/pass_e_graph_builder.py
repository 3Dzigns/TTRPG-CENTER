...
class GraphBuilder:
    ...
    def _load_source_metadata(self, job_dir: Path) -> SourceMetadata:
        """
        Load source metadata required for Neo4j persistence.
